...
<body>
    ...
    <div class="d-flex justify-content-center gap-3">
        <ul class="nav">
            ...
            <li class="nav-item">
                <a class="btn btn-outline-verde2 text-dark rounded-pill border-0" href="signup">Estudiante</a>
            </li>
            <li class="nav-item">
                <a class="btn btn-outline-verde2 rounded-pill border-0" href="signup2">Publico General</a>
            </li>
        </ul>
    </div>
                        ...
                        <form class="row g-3 needs-validation" novalidate>
                            ...
                            <div class="col-md-4">
                                ...
                                <div class="invalid-feedback">
                                    Por favor escribir tu matricula.
                                </div>
                            </div>
                            <div class="col-md-4">
                                <label for="validationCustom04" class="form-label">Grado academico</label>
                            ...
                            <div class="col-md-4">
                                <label for="validationCustom04" class="form-label">Carrera</label>
                                <select class="form-select" id="validationCustom04" required>
                                    <option selected disabled value="">seleccionar</option>
                                    <option>...</option>
                                </select>
