...
<body>
    ...
    <!--card star -->
    <div class="card mb-3 mx-auto mt-5 btn-outline-blanquito" style="max-width: 500px;">
        <div class="row g-0">
            <div class="col-md-11">
                <div class="card-body y px-3" style="text-align: justify;">
                    ...
                    <div>
                        ...
                        <div class="input-group">
                            <input type="password" id="inputPassword5" class="form-control form-control-sm mx-auto"
                    ...
                    <p class="mt-3" style="text-align: center">¿Aún no tienes una cuenta <a class="tn-outline-verde1 "
                            href="#">Regístrate</a>? </p>
                </div>
            </div>
        </div>
            ...
            <div class="row">
                ...
                <div class="col-md-3 float-md-end mb-3 ms-md-3">
                    ...
                    <ul class="list-inline mx-auto text-center">
                        ...
                        <li class="list-inline-item"><a href="#"><i class="bi bi-envelope h3 text-white"></i></a>
                        </li>
                        <li class="list-inline-item"><a href="#"><i class="bi bi-instagram h3 text-white"></i></a>
                        </li>
                    </ul>
                </div>
