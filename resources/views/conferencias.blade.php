...
<body>
    ...
    <div class="d-flex justify-content-center gap-3">
        <ul class="nav">
            ...
            <li class="nav-item">
                <a class="btn btn-outline-verde2 text-dark rounded-pill border-0" href="conferencias">Conferencias</a>
            </li>
            <li class="nav-item">
                <a class="btn btn-outline-verde2   rounded-pill border-0" href="talleres">Talleres</a>
            </li>
        </ul>
    </div>
        ...
        <div class="row justify-content-center">
            <div class="col-md-3 mb-3">
                <div class="card" style="width: 15rem;">
                    ...
                    <div class="card-body">
                        <h3 class="text-center">Conferencia</h3>
